...
const protectedRequests = [
  ...
  ["GET", "/api/episodes"],
  ["GET", "/api/events"],
  ["GET", "/api/working-files"],
  ["POST", "/api/working-files/uploads/request-url"],
  ["POST", "/api/working-files/uploads/complete"],
  ["GET", "/api/working-files/00000000-0000-0000-0000-000000000000/download"],
  ["GET", "/api/files"],
